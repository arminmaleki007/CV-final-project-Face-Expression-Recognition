...
def run_training():
    ...
    #data_augmentations = get_data_augmentations()
    ...
    train_dataset = datasets.ImageFolder(f'{args.fer_path}/train', transform=data_transforms_train	) 
    #train_dataset_augmented = AugmentedDataset(train_dataset, data_augmentations)
    ...
    #val_dataset_augmented = AugmentedDataset(val_dataset, data_augmentations)       
    ...
    val_dataset = datasets.ImageFolder(f'{args.fer_path}/validation',transform=data_transforms_val)
